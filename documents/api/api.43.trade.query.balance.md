...
> 当返回main_code=“MC_310001”或“MC_310002”时，表示余额查询发生异常，请核对错误信息后，重新调用本接口。  
...
- (void)doWork
{
  ...
  [UMSCashierPlugin umsBalanceInquiry:paramDic ViewController:self Delegate:self];
}
```
```java
// Android APK集成示例
...
// 请求参数 (ums_request)
{
    "business_id": "ums.trade.query.balance.ow3rvadd3",
    "data":
    {
...
<table style="text-align:left;">
    ...
    <tr>
        ...
        <td>-</td>
        <td>●</td>
        <td>固定ums.trade.query.balance.ow3rvadd3</td>
        <td>-</td>
        <td>-</td>
    </tr>
    <tr>
