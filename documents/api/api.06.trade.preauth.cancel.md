...
- (void)doWork
{
  ...
  [UMSCashierPlugin umsPreAuthCancel:dic ViewController:self Delegate:self];
}
```
```java
// Android APK集成示例
...
// 请求参数 (ums_request)
{
    "business_id": "ums.trade.preauth.cancel.q4nro9ty",
    "data": {
    ...
    "sign": "KPO7SBWZ2qQqDnDQw1PZ2QGrwqYIRl3YjP5XD5eKitaWPuxFXGXjN5spKirh0x8dNM6EDQNyz8Kxj5basbmREaEo9Voj/b8hp8rqdqEXAVHwIJKvFz+/xX6RBo6WmCWlcCUQmuhnexpsKyIIHuijMuC/FDZZ1BCHtdY2fkw+VMA="
}
```
...
<table style="text-align:left;">
    ...
    <tr>
        ...
        <td>-</td>
        <td>●</td>
        <td>固定ums.trade.prea<br>uth.cancel.q4nro9ty</td>
        <td>-</td>
        <td>-</td>
    </tr>
    <tr>
    ...
    <tr>
        <th rowspan="2">05</th>
        <th align="left" colspan="6">原预授权商户订单号</th>
    </tr>
    <tr>
        <td>-</td>
...
<table>
    ...
    <tr>
        ...
        <td>-</td>
        <td>接口标识</td>
        <td>预授权撤销交易<br>固定ums.trade.preauth.cancel.q4nro9ty</td>
    </tr>
    <tr>
        <th rowspan="1">02</th>
        <td>main_code</td>
