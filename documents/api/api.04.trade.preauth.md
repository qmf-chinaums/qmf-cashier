...
- (void)doWork
{
  ...
  [UMSCashierPlugin umsPreAuth:dic ViewController:self Delegate:self];
}
```
```java
// Android APK集成示例
...
// 请求参数 (ums_request)
{
    "business_id": "ums.trade.preauth.z1r1inf1",
    "data": {
        "billsMID": "shouji000000004",
        "billsTID": "sj000004",
        "merOrderId": "1498126600729",
        "merOrderDesc": "buy house",
        "operator": "000001",
        "amount": "1",
        "isSupportDebitCard": "1",
    ...
    "sign": "Q5mrGBH2IaTHh9JUjvC86j6Rw9w0oflbz6iD7ZrxDUiGl+RZmnaHJzzHxWUPunpSi9JVVLAnbW+gCSKYcRDgPaAP7FMElbAyGR6nMidtLFRxaLBlvGSYxcu6qVq6l1N/4aTl/YboST99KkYEhk6o1C/pKINO6yacjbc4p75/Q44="
}
```
...
<table style="text-align:left;">
    ...
    <tr>
        ...
        <td>-</td>
        <td>●</td>
        <td>固定ums.trade.preauth.z1r1inf1</td>
        <td>-</td>
        <td>-</td>
    </tr>
    <tr>
    ...
    <tr>
        <th rowspan="2">07</th>
        <th align="left" colspan="6">是否支持借记卡</th>
    </tr>
    <tr>
        <td>-</td>
        <td>isSupportDebitCard</td>
        <td>○</td>
        <td>"0","1"</td>
        <td>"0"</td>
        <td>当前预授权是否支持借记卡<br>◆"0"：不支持借记卡<br>◆"1": 支持借记卡</td>
    </tr>
    <tr>
        <th rowspan="2">08</th>
...
<table>
    ...
    <tr>
        ...
        <td>-</td>
        <td>接口标识</td>
        <td>预授权交易<br>固定ums.trade.pay.cancel.3swpkouq</td>
    </tr>
    <tr>
        <th rowspan="1">02</th>
        <td>main_code</td>
