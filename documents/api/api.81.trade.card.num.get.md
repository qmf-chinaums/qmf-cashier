...
> 当返回main_code=“MC_310001”或“MC_310002”时，表示刷卡取卡号发生异常，请核对错误信息后，重新调用本接口。  
...
- (void)doWork
{
  ...
  [UMSCashierPlugin umsGetCardNum:paramDic ViewController:self Delegate:self];
}
```
```java
// Android APK集成示例
...
// 请求参数 (ums_request)
{
    "business_id": "ums.trade.card.num.get.o5ha1e8n",
    "data":
    {
...
<table style="text-align:left;">
    ...
    <tr>
        ...
        <td>-</td>
        <td>●</td>
        <td>固定ums.trade.card.num.get.o5ha1e8n</td>
        <td>-</td>
        <td>-</td>
    </tr>
    <tr>
